...
class ImageGraph:
    ...
    def bfs(self, start_index, color):
        ...
        while not queue.is_empty():
            ...
            if vertex.color == target_color and vertex.color != color:
                vertex.color = color
...
def create_graph(data):
    ...
    start_vertex, fill_color = lines[3 + num_vertices + num_edges].split(',')
    return graph, int(start_vertex), fill_color
